      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <span className="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded">Intermédiaire (60,000 FCFA)</span>
            <span className="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded">Avancé (100,000 FCFA)</span>
            <span className="bg-orange-100 text-orange-800 text-xs font-medium px-2.5 py-0.5 rounded ml-2">+5,000 FCFA frais d'inscription</span>
            <span className="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded">+70,000 FCFA pour la certification</span>
          </div>
        </div>
