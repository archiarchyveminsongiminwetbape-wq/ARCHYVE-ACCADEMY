...
import { FaLaptopCode, FaMobileAlt, FaShieldAlt, FaServer, FaWhatsapp, FaStar, FaQuoteLeft } from 'react-icons/fa';
...
const Home: React.FC = () => {
  ...
  const stats = [
    ...
    { number: '7+', label: 'Formations disponibles' },
  ...
  const temoignages = [
    {
      ...
      note: 5,
      texte: "Grâce à ARCHYVE Academy, j'ai pu transformer ma passion pour le code en une carrière professionnelle.",
    ...
    },
    {
      ...
      note: 5,
      texte: "La formation en Data Science m'a ouvert les portes de l'analyse de données dans une grande entreprise bancaire.",
    ...
    },
    {
      ...
      note: 5,
      texte: "La formation en cybersécurité était très complète et à la pointe des dernières technologies.",
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Ce que disent nos étudiants</h2>
              ...
              <div key={index} className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">{temoignage.formation}</p>
                ...
                <div className="relative mb-3">
                  <FaQuoteLeft className="text-blue-200 text-xl absolute -top-1 -left-1" />
                  <p className="text-gray-700 italic pl-5 text-sm">
                    {temoignage.texte}
                  </p>
                </div>
